...
main:
    ...
    move  $s1, $v0                  # Salva il valore letto.
                                    ...
                                    # Chiama la funzione 'isGreaterThan'.
    ...
    jal   isGreaterThan             # Chiama 'isGreaterThan'.
...
isGreaterThan:
    ...
    beq   $t0, $t1, igt_return      # Se i due falori sono uguali, restituisce false.

    slt   $t2, $t0, $t1             # Se il primo valore e' il minore, imposta ($t2 = 1)...
    beq   $t2, 0x1, igt_return      # ...e restituisce false.
